...
<head>
    <meta charset="UTF-8">
    <title>My Proposals - Approved</title>
...
<div class="main-layout">
    ...
    <div class="content">
        <div class="top-bar">
            <h3>My Proposals</h3>
            <div class="user-info"><span><?php echo $_SESSION['name']; ?> <i class="fas fa-user-circle"></i></span></div>
        </div>

        <div class="scrollable-content">
            
            <div class="researcher-tabs">
                <a href="my-proposals.php" class="researcher-tab">All</a>
                ...
                <a href="my-proposals-approved.php" class="researcher-tab active">Approved</a>
...
<tr>
    <td colspan="5" style="text-align:center;">No approved proposals yet</td>
</tr>
...
<tr>
    ...
    <td>
        <span class="status-badge text-green">✔ Approved</span>
    </td>
